<section class="profile-section">
    <header class="profile-section-header">
        <div class="section-label">{{ __('app.profile.password.eyebrow') }}</div>
        <h2>{{ __('app.profile.password.title') }}</h2>
        <p>{{ __('app.profile.password.description') }}</p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="profile-form">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('app.auth.fields.current_password')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('app.auth.fields.new_password')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('app.auth.fields.confirm_password')" />
